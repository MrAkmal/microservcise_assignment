package com.example.procurement_method_service.security;
...
@Aspect
@Component
public class ProcurementMethodAspect {




    @Before("execution( * com.example.procurement_method_service.procurementMethod.ProcurementMethodController.*(..))")
