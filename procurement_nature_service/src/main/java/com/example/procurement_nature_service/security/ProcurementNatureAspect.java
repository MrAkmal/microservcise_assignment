package com.example.procurement_nature_service.security;
...
@Aspect
@Component
public class ProcurementNatureAspect {



    @Before("execution( * com.example.procurement_nature_service.procurementNature.ProcurementNatureController.*(..))")
